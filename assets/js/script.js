...
var calc2_title_de = `Markerunspezifische Umrechung`;
...
<p>Steroidhormone, neuroaktive Steroide und Neurotransmitter sind sowohl für das Verständnis der Entstehung von Krankheiten als auch für die Erforschung grundlegender physiologischer Prozesse von zentraler Bedeutung. Zahlreiche psychobiologische Studien beziehen entsprechende Marker in ihr Studiendesign ein und so können diese Marker aus unterschiedlichen Gewebeproben (z.B. Blut, Urin, Haar, Speichel) mit diversen biochemischen Analyseverfahren und Techniken (z.B. ELISA, RIA, LC MS/MS) gemessen werden. In Abhängigkeit davon, welches Gewebe und welche Untersuchungsmethode verwendet wird, werden die Ergebnisse anhand entsprechend unterschiedlicher Einheiten (z.B. pg/ml, pmol/L) und Standardkurven dargestellt. Das verkompliziert den Vergleich von Ergebnissen zwischen Studien und erschwert die studienübergreifende Interpretation von Befunden.</p>
<p>Ein einfacher, aber effektiver Weg, um die Vergleichbarkeit von Ergebnissen zu verbessern ist es, die <b>Umrechnung verschiedener chemischer Einheiten</b> zu erleichtern. Hierzu ist ein grundlegendes Wissen über die molare Masse eines spezifischen Markers notwendig. Möchte man beispielsweise die Konzentration von freiem Testosteron von pg/ml zu pmol/L umrechnen, multipliziert man den Ausgangswert mit 3.47 (Umrechnungsfaktor). Um anderen WissenschaftlerInnen und KlinikerInnen diesen zusätzlichen Arbeits- und Zeitaufwand zu ersparen, möchten wir hiermit ein einfaches, schnelles und frei zugängliches Umrechnungsinstrument anbieten, den <b>Universität Zürich (UZH) Masseneinheitsrechner.</b> </p>
<p>Der UZH Masseneinheitsrechner beinhaltet die am häufigsten vorkommenden chemischen Einheiten zentraler Marker in der biopsychologischen Forschung. Wir bieten den UZH Masseneinheitsrechner als frei zugängliches Online-Tool an, damit interessierte WissenschaftlerInnen und KlinikerInnen Ergebnisse schnell, einfach und kostenfrei umrechnen können. </p>
<p>Folgendes sollte bei der Umrechnung beachtet werden: Für die direkte Vergleichbarkeit von Ergebnissen zwischen Studien oder dem Vergleich mit publizierten Referenzenwerten muss darauf geachtet werden, dass nur innerhalb eines biologischen Mediums (z.B. Speichel mit Speichel, Blutserum mit Blutserum) verglichen wird. Zudem sollten Populationsmerkmale wie Alter und Geschlecht beachtet werden. Schwangere Frauen zeigen beispielsweise andere Referenzwerte für Progesteron als nicht-schwangere Frauen im gleichen Alter. Weiterhin besitzen unterschiedliche biochemische Analyseverfahren unterschiedliche Messbereiche, in denen vorliegende Konzentrationen (minimal oder maximal) messbar sind. Diese Messbereiche sind besonders in Populationen mit niedrigen Konzentrationen zu beachten, wozu beispielsweise Männer im fortgeschrittenen Alter oder postmenopausale Frauen mit eher niedrigen Östrogen- und Testosteronwerten gehören. Für weitere Informationen zur Umrechnung von Masseneinheiten und zur Vergleichbarkeit von Forschungsergebnissen verweisen wir an dieser Stelle auf unsere unten angegebenen Publikationen.</p>`;
...
function changeLang(language){
    ...
    if(language == "en"){
        ...
        $("#calc_title").text("Markerspezifische Umrechung");
     ...
     if(!$.isNumeric(valToConvert)){
        ...
        proceed = 0;
            ...
            if(lang == "en"){
                ...
                var message = "This system expects a number. pls review entry."
